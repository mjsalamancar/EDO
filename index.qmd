...
<div style="text-align: center; margin: 20px 0; display: flex; align-items: center; justify-content: center; gap: 10px;">
  <img src="https://i.pinimg.com/originals/8f/1a/5b/8f1a5bd59ba880167442d3220bce498f.gif" 
       width="60px" 
       height="60px" 
       style="object-fit: cover; border-radius: 50%; mix-blend-mode: screen; opacity: 0.9; filter: drop-shadow(0 0 5px rgba(255, 255, 255, 0.5));">
  
  <span style="font-family: 'Quicksand', sans-serif; font-weight: 600; color: #ff8da1; font-size: 0.9em; letter-spacing: 0.5px; border-bottom: 2px solid #ffc1cc; padding-bottom: 3px;">
