...
<div style="text-align: center; margin: 30px 0; display: flex; flex-direction: column; align-items: center; justify-content: center;">
  ...
  <div style="background: #1a1a1a; width: 60px; height: 60px; overflow: hidden; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
    <img src="https://raw.githubusercontent.com/mjsalamancar/EDO/main/bolita.gif" 
         style="width: 100%; height: auto; mix-blend-mode: screen; filter: brightness(1.2);">
  </div>

  <span style="font-family: 'Quicksand', sans-serif; font-weight: 600; color: #ff8da1; font-size: 1.1em; letter-spacing: 0.5px; border-bottom: 2px solid #ffc1cc; margin-top: 10px; padding-bottom: 5px;">
