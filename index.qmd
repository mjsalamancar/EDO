...
<div style="text-align: center; margin: 30px 0; display: flex; flex-direction: column; align-items: center; justify-content: center;">
  ...
  <div style="background: #1a1a1a; width: 70px; height: 70px; overflow: hidden; border-radius: 50%; display: flex; align-items: center; justify-content: center; box-shadow: 0 0 15px rgba(255, 141, 161, 0.3);">
    <img src="https://raw.githubusercontent.com/mjsalamancar/EDO/main/bolita.gif" 
         style="width: 120%; height: auto; mix-blend-mode: screen; filter: brightness(1.3);"
         alt="Convergencia">
  </div>

  <span style="font-family: 'Quicksand', sans-serif; font-weight: 600; color: #ff8da1; font-size: 1.1em; letter-spacing: 0.5px; border-bottom: 2px solid #ffc1cc; margin-top: 15px; padding-bottom: 5px;">
